...
export default function KnowledgeHubLayout({
  ...
  // Navigation items with language-aware hrefs
  const navigationItems = [
    {
      id: 'overview',
      name: 'Overview',
      href: href(currentLang, '/dashboard/knowledge-hub'),
      icon: Home
    },
    {
      id: 'cognitive-biases',
      name: 'Cognitive Biases',
      href: href(currentLang, '/dashboard/knowledge-hub/category/cognitive-biases'),
      icon: Brain
    },
    {
      id: 'persuasion-principles',
      name: 'Persuasion Principles',
      href: href(currentLang, '/dashboard/knowledge-hub/category/persuasion-principles'),
      icon: Users
    },
    {
      id: 'behavioral-economics',
      name: 'Behavioral Economics',
      href: href(currentLang, '/dashboard/knowledge-hub/category/behavioral-economics'),
      icon: TrendingUp
    },
    {
      id: 'ux-psychology',
      name: 'UX Psychology',
      href: href(currentLang, '/dashboard/knowledge-hub/category/ux-psychology'),
      icon: Zap
    },
    {
      id: 'emotional-triggers',
      name: 'Emotional Triggers',
      href: href(currentLang, '/dashboard/knowledge-hub/category/emotional-triggers'),
      icon: BookOpen
    }
  ];
  ...
  const isActive = (itemHref: string) => {
    if (itemHref === href(currentLang, '/dashboard/knowledge-hub')) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <header className="flex items-center justify-between mb-6 sm:mb-8">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              >
                <Link href={href(currentLang, '/dashboard')}>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              >
                <Link href={href(currentLang, '/dashboard/knowledge-hub/bookmarks')}>
              ...
              <Button
                ...
                className="text-gray-400 hover:text-yellow-400"
              >
                <Link href={href(currentLang, '/dashboard/knowledge-hub/progress')}>
              ...
              <SheetContent side="right" className="w-80 bg-gray-900 border-gray-800">
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="space-y-2 pt-4 border-t border-gray-800">
                    ...
                    >
                      <Link href={href(currentLang, '/dashboard/knowledge-hub/bookmarks')} onClick={() => setIsMobileMenuOpen(false)}>
                    ...
                    <Button
                      ...
                      className="w-full justify-start text-gray-400 hover:text-yellow-400"
                    >
                      <Link href={href(currentLang, '/dashboard/knowledge-hub/progress')} onClick={() => setIsMobileMenuOpen(false)}>
